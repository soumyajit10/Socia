...
public class GoogleProfileLoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_google_profile_login);
        circleImageView = findViewById(R.id.gmail_profile_pic);
        logout = findViewById(R.id.gmail_logout);
        name = findViewById(R.id.name);
        email = findViewById(R.id.email);

        progressDialog = new ProgressDialog(GoogleProfileLoginActivity.this);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(GoogleProfileLoginActivity.this);
                                ...
                                Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(new ResultCallback<Status>() {
                                    ...
                                    public void onResult(@NonNull Status status) {
                                        if(status.isSuccess()){
                                            ...
                                            Toast.makeText(GoogleProfileLoginActivity.this, "Gmail Logged out successfully!", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(GoogleProfileLoginActivity.this, MainActivity.class);
                                            startActivity(intent);
                                            finish();
                                        }else{
                                            Toast.makeText(GoogleProfileLoginActivity.this, "Gmail Log out failed!", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
